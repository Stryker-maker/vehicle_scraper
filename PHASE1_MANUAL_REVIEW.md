...
- The wrapper disables the legacy `max_results` cap during collection. Every filtered listing saved by the source scraper is retained, including result sets larger than 50 or 200 vehicles.
