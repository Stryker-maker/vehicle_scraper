...
MANUAL_REVIEW_FIELDS = [
    ...
    "make",
    "make_evidence_status",
    "model",
    "model_evidence_status",
    "trim",
    "trim_evidence_status",
    "price_cad",
    ...
    "fuel",
    "fuel_evidence_status",
    "accident_claim",
    "accident_evidence_status",
    "dealer",
    "dealer_evidence_status",
    "seller_type_claim",
    "seller_type_evidence_status",
    "dealer_address",
...
def chrome_desktop_headers(accept_language: str = "en-CA,en;q=0.9") -> dict[str, str]:
    """
    Return a well-formed desktop Chrome header set suitable for scraping.

    - Default Accept-Language is en-CA,en;q=0.9 to preserve previous behaviour.
    """
    return {
        "User-Agent": (
